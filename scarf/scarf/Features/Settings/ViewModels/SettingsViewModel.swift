...
final class SettingsViewModel {
    ...
    var providers = ["anthropic", "openrouter", "nous", "openai-codex", "google-ai-studio", "xai", "ollama-cloud", "zai", "kimi-coding", "minimax", "custom"]
    ...
    func setBaseURL(_ value: String) { setSetting("model.base_url", value: value) }
